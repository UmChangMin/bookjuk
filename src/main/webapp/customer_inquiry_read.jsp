		...
		<div class="cutomers">
			...
			<div class="customer_tab">
				<ul>
					...
					<li><a href="${root}/customer_inquiry_list.jsp" class="customer_inquiry"><img src="${root}/img/customer/customer_inquiry_pink.png">1:1문의</a></li>
				</ul>
			</div>
			<!-- 내용부분 시작 -->
			...
			<div class="customer_inquiry_button" align="center">
				<input type="button" value="수정" onclick="location.href='${root}/customer_inquiry_update.jsp'"/>
				<input type="button" value="목록" onclick="location.href='${root}/customer_inquiry_list.jsp'"/>
