		...
		<div class="service_sub">
			...
			<div class="service_content">
				...
				<div class="service_title">
					...
					<div class="service_content02"><div>주문취소입니다.</div></div>
				</div>
			...
			<div class="service_contact_button" align="center">
				<input type="button" value="수정" onclick="location.href='${root}/service/contact/update.do'"/>
				<input type="button" value="목록" onclick="location.href='${root}/service/contact/list.do'"/>
				<input type="button" value="삭제" onclick="contactDelete()"/><!-- alert창 띄우고 삭제하시겠습니까? -->
			</div>
			<!-- 버튼 끝 -->
			</div>
		</div>
