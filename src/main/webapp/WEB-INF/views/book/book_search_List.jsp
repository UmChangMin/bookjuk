					...
					<c:if test="${search!=null}">
						...
						<div class="bookDetail_mid_images">
							<div class="bookDetail_mid_image">
								<ul>
									<li class="bookDetail_mid_list_show"><a href="${root}/book/book_search_List.do?pageNumber=${pageNumber}&viewType=list"><img src="${root}/img/book/list_var_pink.png"></a></li>
									<li class="bookDetail_mid_image_show"><a href="${root}/book/book_search_List.do?pageNumber=${pageNumber}&viewType=image"><img src="${root}/img/book/grid_pink.png"></a></li>
								</ul>
							</div>
						</div>
						<!-- 도서 보기 끝 -->
									...
									<ul>
										<li>
											<div class="bookList_mid_content_figure">
												<a href="${root}/book/book_search_List.do?book_num=${bookDto.book_num}">
													<img src="${root}${bookDto.book_img}">
												</a>
											</div>
											<div class="bookList_content_inbfo">
												<p class="bookList_content_title"><a href="${root}/book/book_search_List.do?book_num=${bookDto.book_num}">${bookDto.book_name}</a></p>
										...
										<li>
											...
											<div class="bookList_mid_content_hot_info">
												<p class="bookList_mid_content_title">
													<a href="${root}/book/book_search_List.do?book_num=${bookDto.book_num}">${bookDto.book_name}</a>
												</p>
