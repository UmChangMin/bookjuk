			...
			<div class="bookLists">
				<div class="bookList">
					...
					<div class="bookList_select">
						<span><a href="${root}/main.do">HOME</a> > </span> <span><a href="${root}/book/list/discount.do">할인도서</a></span>
					</div>
					<!-- 도서분류 끝 -->
					<div class="bookList_mid">
						...
						<div class="bookList_pageNumber">
							...
							<c:if test="${startPage > pageBlock}">
								<a href="${root}/book/list/discount.do?pageNumber=${startPage - pageBlock}" class="bookList_num_before">이전</a>
							</c:if>
							
							<c:forEach var="i" begin="${startPage}" end="${endPage}" >
								<a href="${root}/book/list/discount.do?pageNumber=${i}" class="bookList_num01">${i}</a>
							</c:forEach>
							
							<c:if test="${endPage < pageCount}">
								<a href="${root}/book/list/discount.do?pageNumber=${startPage + pageBlock}" class="bookList_num_next">다음</a>
							</c:if>
						</div>
						<!-- 페이지 번호 끝 -->
					</div>
