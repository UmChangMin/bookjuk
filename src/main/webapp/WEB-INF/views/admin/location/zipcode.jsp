...
<script type="text/javascript" src="${root}/javaScript/member/jqueryScript.js"></script>
</head>
<body>
	<div align="center">
		...
		<table align="center">
			<c:choose>
				...
				<c:when test="${zipcodeList.size() > 0 }">
					<tr><td align="center">아래의 우편번호를 클릭하세요.</td></tr>
					<c:forEach var="zipcode" items="${zipcodeList }">
						<tr>
							<td><a href="javascript:sendAddress('${zipcode.zipcode }', '${zipcode.sido }', '${zipcode.gugun }', '${zipcode.dong}', '${zipcode. ri}', '${zipcode.bunji}')">
