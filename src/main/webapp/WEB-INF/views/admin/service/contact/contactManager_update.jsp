...
<link rel="stylesheet" type="text/css" href="${root }/css/admin/service/contact/contactManager_update.css">
			...
			<div class="wrap">
				<div class="content_wrap">
					...
					<div class="content_wrap_body_right">
						<!-- Content 시작 -->
						<div class="content">
							<div class="content_title_signature" align="center">1:1문의수정</div>	
									...
									<div class="notice_content">
										...
										<ul>											
											...
											<li class="notice_content_value">
												<p>
												자세한 오류 / 불편 사항
												(오류 신고의 경우 자세한 오류 페이지 정보를 제공해 주시면, 빠른 문제 해결에 도움이 됩니다.)
												-결제 관련문의일 경우 사용하신 결제수단(핸드폰, 카드, 적립금  등)에 대한 정보도 함께 보내주시면 더욱 빠른 처리가 가능합니다.
												-북적북적 서비스에 대해 좋은 제안이나 의견을 남겨주시면 더 나은 서비스 제공을 위한 밑거름으로 삼겠습니다
												
												1. 오류 / 불편 발생 일시(예시 : 2018-01-01) 
												=> 2018-01-02
												2. 오류 / 불편 내용
												=>어제 책 2권을 주문했는데 오늘 한 권 더 주문하려구요~ 배송비가 2번 결제될 것 같아 재결제를 위해 기존 결제 취소부탁드립니다.
									...
									<div class="notice_content">
										<div class="contact_content">
											<ul>											
												...
												<li class="contact_content_value"><textarea placeholder="내용">2018-01-02일에 발생한 상황에 따라 주문취소를 신청하셨습니다. 고객님께서 문의하신 내역은 정상처리 되었습니다. 카드사 측에 따라 3일 ~ 5일 안에 결제하신 계좌를 통해 환불 또는 결제 시 작성하신 계좌를 통해 환불 될 예정이며, 적립금은 즉시 환불처리 됩니다.보다 자세한 답변을 원하시거나, 다른 불편함이 있으시면 이메일 또는 1:1문의를 통해 접수 부탁드립니다. 빠른 시일 내에 답변드리겠습니다.앞으로도 고객님이 불편함을 느끼지 않도록 더욱 노력하는 북적북적이 되겠습니다.이용해 주셔서 감사합니다.</textarea></li>
											</ul>
										</div>									
									</div>									
								</div>
