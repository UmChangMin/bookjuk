...
<link rel="stylesheet" type="text/css" href="${root }/css/contactManager_read.css">
<script type="text/javascript" src="${root }/jquery.js"></script>
								      ...
								      <div class="col-lg-10 col-lg-offset-2 col-lg-margin-left" id="btn-margin">
								      	<ul>
								      		<li>
										        ...
										        <button type="submit" class="btn btn-default" id="" onclick="location.href='contactManager_write.jsp'">답글달기</button>
										        <button type="submit" class="btn btn-default" id="" onclick="location.href='contactManager_update.jsp'">답글수정</button>
										        <button type="reset" class="btn btn-default" id="" onclick="location.href='contactManager_delete.jsp'">답글삭제</button>
									        </li>
									    </ul>
								      </div>
								</div>
