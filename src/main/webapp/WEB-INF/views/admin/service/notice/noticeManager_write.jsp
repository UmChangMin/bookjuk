...
<link rel="stylesheet" type="text/css" href="${root }/css/noticeManager_write.css">
<script type="text/javascript" src="${root }/jquery.js"></script>
									      ...
									      <div class="col-lg-10 col-lg-offset-2 col-lg-margin-left" id="btn-margin">
									      	<ul>
									      		<li>
											        ...
											        <button type="submit" class="btn btn-default" id="" onclick="location.href='noticeManager_writeOk.jsp'">완료</button>
