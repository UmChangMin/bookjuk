...
<link rel="stylesheet" type="text/css" href="${root }/css/service/notice/noticeManager.css">
								...
								<div class="form_style">
									<div class="notice_content">
										...
										<ul>
											...
											<li class="notice_title"><a href="noticeManager_read.jsp">[공지] 1월 12일 고객센터 운영시간 변경 안내</a></li>
