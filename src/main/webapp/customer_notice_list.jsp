		...
		<div class="cutomers">
			...
			<div class="customer_tab">
				<ul>
					...
					<li><a href="#" class="customer_notice"><img src="${root}/img/customer/information_pink.png">공지사항</a></li>
				...
				<div class="customer_inner">
					...
					<c:forEach var="i" begin="1" end="10">	
						<div class="customer_notices">
							<div><a href="${root}/customer_notice_read.jsp">[공지] 1월12일 고객센터 운영시간 변경 안내</a></div>
