...
<script type="text/javascript" src="${root}/js/real_time.js"></script>
<script type="text/javascript" src="${root}/js/main_header.js"></script>
...
<%-- 	<%@ include file="/login.jsp"%>
	<%@ include file="/registe.jsp"%>
	<%@ include file="/ordermain.jsp"%>  --%>
	<div id="header">
		<div class="header_top">
			<div class="header_top_inner">
				<ul class="header_lnb_right">
					...
					<li><a class="openMask2" href="#">회원가입</a></li>
					<li><a class="" href="">장바구니</a></li>
					<li><a class="openMask3" href="#">주문/배송조회</a></li>
		...
		<div class="header_mainGnb_wrap">
			<div class="header_mainGnb_inner">
				<ul class="header_gnb_list">
					<li><a href="#" class="header_title_menu_category">전체카테고리&nbsp;<img
							src="${root}/img/main_header/download.png"></a></li>
					<li><a href="${root}/book_best.jsp"
						class="header_title_menu_best">베스트셀러</a></li>
